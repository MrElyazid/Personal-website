...
const elements = {
  ...
  home: {
    ...
    opinions: Array.from({ length: 7 }, (_, i) =>
      document.getElementById(`opinion-${i + 1}`)
    ),
    interestsTitle: document.getElementById("interests-title"),
    interests: Array.from({ length: 6 }, (_, i) =>
      document.getElementById(`interest-${i + 1}`)
    ),
  ...
  about: {
    ...
    educationHeaderLocation: document.getElementById(
    ...
    chessItems: Array.from({ length: 3 }, (_, i) =>
      document.getElementById(`chess-item-${i + 1}`)
    ),
    additionalTitle: document.getElementById("additional-title"),
    additionalItems: Array.from({ length: 4 }, (_, i) =>
      document.getElementById(`additional-item-${i + 1}`)
    ),
  },
  ...
  skills: {
    ...
    programmingIntermediate: document.getElementById(
  ...
  projects: {
    // Projects page elements can be added here when needed
  },

  blog: {
    // Blog page elements can be added here when needed
  },
};
...
function updateNavigation(data) {
  if (elements.navPortfolio)
    elements.navPortfolio.textContent = data.nav.portfolio;
  ...
  if (elements.navSkills)
    elements.navSkills.textContent = ` ${data.nav.skills}`;
  if (elements.navProjects)
    elements.navProjects.textContent = ` ${data.nav.projects}`;
  if (elements.navBlog) elements.navBlog.textContent = ` ${data.nav.blog}`;
}
...
function updateAboutPage(data) {
  ...
  about.educationHeaderLocation.textContent =
    data.about.education.headers.location;
  about.educationHeaderTime.textContent = data.about.education.headers.time;
  about.educationHeaderComment.textContent =
    data.about.education.headers.comment;
...
function updateSkillsPage(data) {
  ...
  skills.programmingIntermediate.innerHTML =
  ...
  if (skills.resumeButton) {
    ...
    skills.resumeButton.innerHTML = `${icon ? icon.outerHTML : ""} ${
      data.skills.resume.button
    }`;
  }
  if (skills.loadingText)
    skills.loadingText.textContent = data.skills.resume.downloading;
